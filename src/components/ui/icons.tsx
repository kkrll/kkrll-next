...
export const CloseIcon = ({ size = 16, className, color = "#FFF9EF" }: IconType) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 20 20"
    ...
    className={cn("block select-none shrink-0 transition-all duration-100", className)}
  >
    <path
...
export const ChevronDownIcon = ({ size = 16, className, color = "white" }: IconType) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 20 20"
...
export const ChevronUpIcon = ({ size = 16, className, color = "white" }: IconType) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 20 20"
...
export const LinkIcon = ({ size = 16, className, color = "white" }: IconType) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 20 20"
...
export const PlusIcon = ({ size = 16, className, color = "#FFF9EF" }: IconType) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 20 20"
...
export const MinusIcon = ({ size = 16, className, color = "#FFF9EF" }: IconType) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 20 20"
