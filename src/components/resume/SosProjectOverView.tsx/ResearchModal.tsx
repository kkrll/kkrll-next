    ...
    <Modal onClose={close}>
      <div className="flex flex-col gap-6">
        ...
        <p>
          ...
          actual reasons behind their recent hirings, telling detailed stories and
          getting more open and excited about the whole process.
        </p>
        <p>So, in the end, we had:</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
          {
            results.map(point => {
              return <div className="p-6 bg-background-07 rounded-3xl">{point}</div>
            })
          }
        </div>
        <Illustration
          src="/img/resume/sos-project-overview/card-recomendation-example.png" caption="Example of recommendations" />
      </div>
    </Modal>
  );
};
