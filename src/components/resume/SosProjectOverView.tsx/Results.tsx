    ...
    <Section className="flex flex-col gap-6">
      ...
      <IntroPoint title="">
        <div className="flex flex-col gap-6">
          ...
          />
          <p>There were still ideas for further Project Overview page enhancements, but it was excluded from the Growth team scope as we switched to the entire Client funnel optimisation.</p>
        </div>
      </IntroPoint>
    </Section>
  )
