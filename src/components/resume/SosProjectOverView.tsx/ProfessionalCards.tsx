  ...
  return (
    <Section className="flex flex-col gap-6">
      ...
      <IntroPoint title="Process">
        ...
        <button className="flex bg-background rounded-xl mb-6 overflow-hidden w-full transition-colors border-1 border-background-05 hover:bg-foreground hover:text-background hover:border-foreground cursor-pointer transition-0.2">
          <Image
