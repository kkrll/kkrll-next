          ...
          return (
            <article key={writing.slug} className="mb-4">
              <Link
                ...
                className={`group flex pr-2 py-2 items-baseline ${
                  isSelected ? "bg-foreground text-background" : "bg-none"
                }`}
              >
                ...
                <span
                  className={`flex-1 border-b-2 border-dotted mx-2 mb-2 ${
                    isSelected ? "border-background/20" : "border-foreground/20"
                  }`}
                />
                <time
